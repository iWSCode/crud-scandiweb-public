<nav class="navbar navbar-expand-lg mb-5 navbar-dark bg-dark">
    <div class="container-fluid px-4">
        ...
        <span>
            <button form="product_form" class="btn btn-outline-white text-white" type="submit">Save</button>
            <a href="/" type="button" class="btn btn-outline-white text-white" type="submit">Cancel</a>
        </span>
    </div>
</nav>
    ...
    <form method="post" id="product_form" class="needs-validation" novalidate>
        <fieldset>
            ...
            <div class="row mb-3 g-3 align-items-center">
                ...
                <div class="col-sm-auto">
                    <span class="form-text">
                        Price needs to be a positive number with minimium 0.01.
                    </span>
                </div>
            </div>
        </fieldset>
        ...
        <div class="row mb-5 g-3 align-items-center">
            ...
            <div class="col-sm-auto">
                <select required id="productType" name="type" class="form-select">
                    <option <?php if (!($product->data['type'] ?? '')) echo "selected"; ?> value="">Type Switcher
                    </option>
