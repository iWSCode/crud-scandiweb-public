<nav class="navbar navbar-expand-lg mb-3 navbar-dark bg-dark">
    <div class="container-fluid px-4">
        ...
        <span>
            <a href="/add-product" type="button" class="btn btn-outline-white text-white" type="submit">ADD</a>
            <form action="/delete-product" method="post" id="delete-form" class="d-inline-block">
                <button for="delete-form" id="delete-product-btn" class="btn btn-outline-white text-white"
                    type="submit">MASS
                    DELETE</button>
            </form>
        </span>
                ...
                <div class="card-body">
                    <div class="form-check-inline">
                        <label class="form-check-label">
                            <input form="delete-form" type="checkbox" class="delete-checkbox form-check-input"
                                name="<?= $product['sku'] ?>">
                        </label>
                    </div>
